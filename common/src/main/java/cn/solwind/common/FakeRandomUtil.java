 ...
 * @author zln
 */
public class FakeRandomUtil {

    /*
     * 素数定义
     */
    // 素数种子Map
    private static Map<Integer, BigInteger> mapPrimeNumber;

    private static BigInteger primeNumber6 = new BigInteger("214748357");
    private static BigInteger primeNumber7 = new BigInteger("6871947653");
    private static BigInteger primeNumber8 = new BigInteger("219902325523");

    static {
        mapPrimeNumber = new HashMap<Integer, BigInteger>();
        mapPrimeNumber.put(6, primeNumber6);
        mapPrimeNumber.put(7, primeNumber7);
        mapPrimeNumber.put(8, primeNumber8);
    }
    ...
    private static String generateRandomNum(long seed, int bits, BigInteger primeNumber) {
        ...
        if (primeNumber == null) {
            ...
            primeNumber = mapPrimeNumber.get(bits);
        }
        // 计算除数
     ...
     * 生成8位数字随机数
     *
     * @param seed 随机数种子，最大值：99999815
     * @return
     */
    public static String generateRandomNum8(long seed) {
        try {
            BigInteger primeNumber8 = new BigInteger("19999963");

            return generateRandomNum(seed, 8, primeNumber8);
     ...
     * 生成6位数字随机数
     *
     * @param seed 随机数种子，最大值：999835
     * @return
     */
    public static String generateRandomNum6(long seed) {
        try {
            BigInteger primeNumber6 = new BigInteger("199967");

            return generateRandomNum(seed, 6, primeNumber6);
     ...
     * 生成7位数字随机数
     *
     * @param seed 随机数种子，最大值：9999965
     * @return
     */
    public static String generateRandomNum7(long seed) {
        try {
            BigInteger primeNumber7 = new BigInteger("1999993");

            return generateRandomNum(seed, 7, primeNumber7);
     ...
     * @return
     */
    public static String generateRandomNum10(long seed) {
        try {
            BigInteger primeNumber10 = new BigInteger("1999999927");

            return generateRandomNum(seed, 10, primeNumber10);
     ...
     * 生成12位数字随机数
     *
     * @param seed 随机数种子，最大值：999999999745
     * @return
     */
    public static String generateRandomNum12(long seed) {
        try {
            BigInteger primeNumber12 = new BigInteger("199999999949");

            return generateRandomNum(seed, 12, primeNumber12);
     ...
     * 生成13位数字随机数
     *
     * @param seed 随机数种子，最大值：9999999999635
     * @return
     */
    public static String generateRandomNum13(long seed) {
        try {
            BigInteger primeNumber13 = new BigInteger("1999999999927");

            return generateRandomNum(seed, 13, primeNumber13);
     ...
     * @return
     */
    public static String generateRandomNum14(long seed) {
        try {
            BigInteger primeNumber14 = new BigInteger("19999999999939");

            return generateRandomNum(seed, 14, primeNumber14);
